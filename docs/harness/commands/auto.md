...
- Phase 0 / Phase 2 拍板 gate(2026-08-03 起由 `grilling` 承接;**gate 義務**(拷問並落檔)
  沿原 brainstorming 契約,**停等語意**依 2026-08-03 提問紀律 — 兩層分開讀)的
  **替代條件**:規格來自 user 撰寫或
  ...
  **(2026-08-03 拍板:撤銷 07-27「grilling 共識拍板必停」例外)**:已成形方案與模糊 idea
  一律回歸「無方向性抉擇 → 推進」— grilling / adhd 逐題預設採建議解標 `[auto-default]`,
  僅方向性抉擇或給不出建議解時停,細節以 feat.md Phase 0 / mod.md Phase 2 分流句為準。
...
- /feat Phase 0 / /mod Phase 2 的**方向性抉擇**停等(2026-08-03 起共識拍板不再必停,
  判準見上方替代條件段)
...
| /feat S 級 | ✓ `/auto Phase 8.5 完成 /feat <desc>`(2026-08-03 起 Phase 0 僅方向性抉擇才停) |
| /feat 中段自動 | `/auto Phase 7 結構化表格全綠 /feat <desc>` |
| /feat L 級 | ⚠ 不建議全自動:Phase 0 對齊價值高;merge 確認已移除,**想在 merge 前人工試用就不要疊** /auto 跑完收尾 |
| /mod S/M 級 | ✓ `/auto tests 全綠 且 **Phase 2 白名單行為保留** /mod <desc>`(2026-08-03 起 Phase 2 僅方向性抉擇才停) |
