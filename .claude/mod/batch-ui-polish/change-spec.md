...
- ChipBubbleView selectedBrokerName 的 derive 路徑與 tooltip DOM 寫入點(L211)以 id 取得方式
- MarketIndexStrength 卡在塞入 breadth 後 1440x900 高度是否仍無捲動(M7 驗證;超高則 breadth 改兩列緊湊排)
- flows e2e 具體落檔(navigation.spec 或既有 flows spec 段)
