    ...
    changes: [
      {
        kind: "fix",
        scope: "global",
        text: "數字欄位的上下調整鈕改為深色;用鍵盤操作時的焦點外框更清楚;開啟頁面時不再閃一下白底",
      },
    ],
  },
  {
    ...
    changes: [
      {
        kind: "feature",
        scope: "global",
        text: "分點反查可以選日期了:回看某分點在過去交易日買賣超了哪些股票(選到休市日會標示實際顯示的是哪一天);從結果點股票跳到個股頁時,個股頁也會自動切到同一天",
      },
    ],
  },
  {
    ...
    changes: [
      {
        kind: "fix",
        scope: "equity",
        text: "分點反查:剛開業的新分點以往要等最多一天才查得到,現在檢視分點時按「重新整理」即可立即更新分點名單",
      },
    ],
  },
  {
    ...
    changes: [
      {
        kind: "fix",
        scope: "options",
        text: "選擇權頁載入大幅加速:盤中重新整理或隔一陣子再開頁,不再卡住數秒才顯示;大盤頁也不再被選擇權頁的資料重算拖慢",
      },
    ],
  },
  {
    ...
    changes: [
      {
        kind: "fix",
        scope: "global",
        text: "大盤頁在資料來源額度用盡期間不再反覆重抓收盤統計,避免加重額度消耗、拖慢整體回應;額度恢復後會自動重試補回",
      },
    ],
  },
  {
