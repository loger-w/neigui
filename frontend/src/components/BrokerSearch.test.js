...
describe("BrokerSearch", () => {
    it("shows placeholder when value is null", () => {
        render(_jsx(BrokerSearch, { trades: trades, value: null, onChange: vi.fn() }));
        expect(screen.getByPlaceholderText("搜尋分點...")).toBeTruthy();
    });
    it("shows broker name when value is set", () => {
        render(_jsx(BrokerSearch, { trades: trades, value: "\u51F1\u57FA-\u53F0\u5317", onChange: vi.fn() }));
    ...
    it("Enter selects active item", async () => {
        ...
        render(_jsx(BrokerSearch, { trades: trades, value: null, onChange: onChange }));
        const input = screen.getByPlaceholderText("搜尋分點...");
        fireEvent.focus(input);
    ...
    it("× button clears value", () => {
        const onChange = vi.fn();
        render(_jsx(BrokerSearch, { trades: trades, value: "\u51F1\u57FA-\u53F0\u5317", onChange: onChange }));
